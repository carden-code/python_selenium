...
try:
    ...
    # pickle.dump(driver.get_cookies(), open(f"{vk_name}_cookies", "wb"))
    driver.get('https://vk.com')
    sleep(5)

    # Открываем файл с кук и добавляем в вебдрайвер
    for cookie in pickle.load(open(f"{vk_name}_cookies", "rb")):
